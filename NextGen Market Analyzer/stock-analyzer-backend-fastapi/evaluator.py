...
class StockAnalyzerModel:
    ...
    def comment_pe(self, value: Optional[float]) -> str:
    ...
    def comment_eps(self, value: Optional[float]) -> str:
    ...
    def comment_dy(self, value: Optional[float]) -> str:
    ...
    def comment_mc(self, value: Optional[float]) -> str:
    ...
    def comment_de(self, value: Optional[float]) -> str:
    ...
    def comment_roe(self, value: Optional[float]) -> str:
    ...
    def comment_roa(self, value: Optional[float]) -> str:
    ...
    def comment_current(self, value: Optional[float]) -> str:
    ...
    def comment_quick(self, value: Optional[float]) -> str:
    ...
    def comment_bv(self, value: Optional[float]) -> str:
    ...
    # helper scoring helpers: _f for quality thresholds, _g for value thresholds
    def _f(self, metric: float, thresholds: List[Tuple[float, int]]) -> int:
        for limit, score in thresholds:
            if metric <= limit:
                return score
        return thresholds[-1][1]

    def _g(self, metric: float, thresholds: List[Tuple[float, int]]) -> int:
        for limit, score in thresholds:
            if metric <= limit:
                return score
        return thresholds[-1][1]
    ...
    def evaluate(self, stock: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = " ".join(feedback.values()) + f" → Quality={quality_score}, Value={value_score}, Overall={overall}."
