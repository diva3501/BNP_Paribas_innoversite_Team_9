...
function buildPortfolioSpecOutput(client){
  "portfolioAnalysis": {
    "totalValue": <number>,
    "sectorDiversification": { "Technology": <pct>, "Financials": <pct>, ... },
    "riskLevel": "Low|Moderate|High",
    "performance": { "oneYearReturn": null, "threeYearReturn": null, "fiveYearReturn": null }
  },
  "possibleDiversification": [
    { "sector": "Consumer Staples", "recommendation": "..." },
    { "sector": "Utilities", "recommendation": "..." }
  ],
  "traderType": "Growth Investor|Balanced|Income/Financials Tilt",
  "summary": "..."
}
